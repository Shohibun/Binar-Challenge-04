    ...
    return (
        <section class="custom-section1 py-5 mb-5">
            <div class="container py-5">
                <div class="row py-5">
                    <div class="col-md-6 d-flex align-items-center justify-content-center custom-cover">
                        <div>
                            <h2 class="font-weight-bold custom-head1">Sewa & Rental Mobil Terbaik di kawasan (Lokasimu)</h2>
